...
class Enemy {
    ...
    fireEffect() {
        ...
        if (!this.fireGraphics) {
            this.fireGraphics =
                new Phaser.GameObjects.Graphics(
                    this.scene
                );
    ...
    setEnraged() {
        ...
        if (!this.isEnraged) {
            ...
            this.customSquareContainer.remove(
                this.customSquare,
                true
            );
            ...
            this.fireGraphics.setPosition(
                -10,
                -10
            );

            this.customSquareContainer.addAt(
                this.fireGraphics,
                0
            );
        } else {
    ...
    disenrage() {
        ...
        this.customSquareContainer.bringToTop(
    ...
    updatePatrol(time: any, delta: any) {
        ...
        if (time >= this.nextPatrolTime) {
            ...
            if (
                !currentAnim ||
                currentAnim.key !== movingAnimationKey
            ) {
                this.sprite.play(
                    movingAnimationKey
                );
